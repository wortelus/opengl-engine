...
SceneLoader::loadSceneD(GLFWwindow &window_reference, const int &initial_width, const int &initial_height) {
    ...
    moon_obj->setColor(glm::vec3(0.5, 0.5, 0.5));
...
SceneLoader::loadSceneE(GLFWwindow &window_reference, const int &initial_width, const int &initial_height) {
    ...
    tree_first.setColor(glm::vec3(0.4, 0.5, 0.1));
    tree_first.setProperties(glm::vec3(0.55, 0.95, 0.1),
                           glm::vec3(0.99, 0.15, 0.1),
                           5.f);
    ...
    for (int i = 0; i < 150; i++) {
        ...
        tree_obj.setColor(glm::vec3(0.2, 0.25, 0.05));
        tree_obj.setProperties(glm::vec3(0.55, 0.95, 0.1),
                               glm::vec3(0.99, 0.15, 0.1),
                               5.f);
    }
        ...
        switch(rand_obj) {
            case 0: {
                auto& bushes_obj = scene->appendObject(bushes, sizeof(bushes),
                                                              glm::vec3(rand_x, tree_height, rand_z), "blinn");
                bushes_obj.setColor(glm::vec3(0.4, 0.85, 0.1));
            ...
            case 3: {
                ...
                suzi_smooth_obj_a.setColor(glm::vec3(0.1, 0.2, 0.95));
                suzi_smooth_obj_a.setProperties(glm::vec3(0.55, 0.95, 0.1),
                                                glm::vec3(0.99, 0.15, 0.1),
                                                32.f);
...
SceneLoader::loadSceneG(GLFWwindow &window_reference, const int &initial_width, const int &initial_height) {
    ...
    suzie_obj.setColor(glm::vec3(1.0, 1.0, 0.0));
    ...
    gift_obj.setColor(glm::vec3(0.8, 0.3, 0.2));
    ...
    tree_obj.setColor(glm::vec3(0.2, 0.25, 0.05));
    tree_obj.setProperties(glm::vec3(0.25, 0.35, 0.1),
